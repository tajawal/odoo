...
class TestSupplierInvoiceGalileoImport(common.TransactionComponentRegistryCase):

    def setUp(self):
        super(TestSupplierInvoiceGalileoImport, self).setUp()
        self._setup_records()
    ...
    def test_supplier_invoice_line_galileo(self):
        ...
        self.assertEquals(first_line.passenger, 'KAMALASANAN/BINU')
        self.assertEquals(first_line.total, 120)
