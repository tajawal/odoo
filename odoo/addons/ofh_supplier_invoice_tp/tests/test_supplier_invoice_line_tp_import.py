...
class TestSupplierInvoiceTpImport(common.TransactionComponentRegistryCase):

    def setUp(self):
        super(TestSupplierInvoiceTpImport, self).setUp()
        self._setup_records()
    ...
    def test_supplier_invoice_line_tp(self):
